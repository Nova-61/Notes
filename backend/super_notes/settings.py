...
WSGI_APPLICATION = 'super_notes.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [ # Классы ограничения скорости запросов
        'rest_framework.throttling.AnonRateThrottle',
    ],
    'DEFAULT_THROTTLE_RATES': { # Ограничение скорости запросов
        'anon': '100/hour',
    },
    'DEFAULT_RENDERER_CLASSES': [ # Рендереры по умолчанию
        'rest_framework.renderers.JSONRenderer',
    ],
    'DEFAULT_PARSER_CLASSES': [ # Парсеры по умолчанию
